...
INSERT INTO `syspsi`.`psicologo` (`id`, `nome`, `sobrenome`, `login`, `senha`, `ativo`) VALUES (2, 'Jose', 'Silva', 'jose', '$2a$10$NHNM3ciz3QIIGNIxdZnvC.vSnlMGU7ALrFairJgWgek91z6QUZN8K', true);
