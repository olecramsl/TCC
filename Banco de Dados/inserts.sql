...
INSERT INTO `syspsi`.`paciente` (`idPsicologo`, `nomeCompleto`, `dataNascimento`, `cpf`, `sexo`, `telefoneContato`, `email`, `logradouro`, `bairro`, `localidade`, `uf`, `cep`, `ativo`) VALUES (1, 'Jacira Cunha', '1930-06-07', '99999999999', 'F', '5198765432', 'jacira@email.com', 'Edgar', 'Aberta', 'Porto', 'RS', '12345789', '1');
